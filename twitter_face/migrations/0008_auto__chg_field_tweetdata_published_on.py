...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TweetData.published_on'
        db.alter_column('twitter_face_tweetdata', 'published_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TweetData.published_on'
        raise RuntimeError("Cannot reverse this migration. 'TweetData.published_on' and its values cannot be restored.")
