...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TweetData.tweeted_content'
        db.add_column('twitter_face_tweetdata', 'tweeted_content',
    ...
    def backwards(self, orm):
        # Deleting field 'TweetData.tweeted_content'
        db.delete_column('twitter_face_tweetdata', 'tweeted_content')
