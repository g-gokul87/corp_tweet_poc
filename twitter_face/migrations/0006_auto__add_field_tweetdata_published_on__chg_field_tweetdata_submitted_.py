...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TweetData.published_on'
        db.add_column('twitter_face_tweetdata', 'published_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 2, 0, 0)),
                      keep_default=False)


        # Changing field 'TweetData.submitted_on'
        db.alter_column('twitter_face_tweetdata', 'submitted_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'TweetData.published_on'
        db.delete_column('twitter_face_tweetdata', 'published_on')


        # Changing field 'TweetData.submitted_on'
        db.alter_column('twitter_face_tweetdata', 'submitted_on', self.gf('django.db.models.fields.DateTimeField')())
